...
static TensorShape getSplit(const HomFCSS::Meta &meta, size_t N) {
  std::cout << meta.weight_shape.dims() << std::endl;
  std::cout << meta.input_shape.dims() << std::endl;
  std::cout << meta.input_shape.length() << std::endl;
  std::cout << meta.weight_shape.cols() << std::endl;
