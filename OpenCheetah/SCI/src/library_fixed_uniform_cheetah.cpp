...
void MatMul2D(int32_t d0, int32_t d1, int32_t d2, const intType *mat_A,
  ...
  std::cout << "HomMatMul on shape " << mat_A_shape << " x " << mat_B_shape
            << std::endl;
  std::cout << "is_A_weight_matrix = " << is_A_weight_matrix << std::endl;
  ...
  std::cout << "weight_shape = " << weight_shape << std::endl;
  ...
  std::cout << "input_shape = " << meta.input_shape << std::endl;
  std::cout << "weight_shape = " << meta.weight_shape << std::endl;
